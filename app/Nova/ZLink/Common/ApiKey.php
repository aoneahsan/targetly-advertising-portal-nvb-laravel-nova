...
class ApiKey extends HiddenResource
{
    /**
     * The model the resource corresponds to.
     *
     * @var class-string<\App\Models\ZLink\Common\ApiKey>
     */
    public static $model = \App\Models\ZLink\Common\ApiKey::class;
    ...
    public function fields(NovaRequest $request)
    {
        return [
            ...
            Text::make('Client id', 'clientId')
                ->sortable()
                ->rules('required', 'max:255')
                ->showWhenPeeking(),

            Text::make('Client Secret', 'clientSecret')
                ->sortable()
                ->rules('required', 'max:255')
                ->showWhenPeeking(),

            Date::make('Expire Date', 'expireDate'),
